      ...
      <CardGroup className="mt-5">
        ...
        <Fade  right cascade>
          ...
          <hr className="separator" />
            <Card.Text>
              <h5>HTML</h5>
              <ProgressBar className="bar" animated variant="success" now={90} label={`${now5}%`} />
              <h5>JavaScript</h5>
              <ProgressBar className="bar" animated variant="success" now={85} label={`${now3}%`} />
              <h5>CSS</h5>
              <ProgressBar className="bar" animated variant="success" now={90} label={`${now6}%`} />
              <h5>React</h5>
              <ProgressBar className="bar" animated variant="success" now={85} label={`${now4}%`} />
              <h5>Node Js</h5>
              <ProgressBar className="bar" animated variant="success" now={75} label={`${now}%`} />
              <h5>MongoBD</h5>
